...
class WebinarsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            // 'name' => 'required|unique:webinars,name,NULL,id,deleted_at,NULL',
            // 'slug' => 'required|unique:webinars,slug,NULL,id,deleted_at,NULL',
            // 'content' => 'required',
            'link' => 'required',
            'title' => 'required'
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->validate($request, [
            // 'name' => 'required|unique:webinars,name,' . $id . ',id,deleted_at,NULL',
            // 'slug' => 'required|unique:webinars,slug,' . $id . ',id,deleted_at,NULL',
            // 'content' => 'required',
            'link' => 'required',
            'title' => 'required'
        ]);
