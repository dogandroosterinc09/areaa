...
class MembersController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->get('change_password') == '1') {
            $input = $request->only(['first_name','middle_name','last_name','user_name','email','is_active','is_featured','is_alist','alist_years','is_luxury','admin_notes','password']);
        } else {
            $input = $request->only(['first_name','middle_name','last_name','user_name','email','is_active','is_featured','is_alist','alist_years','is_luxury','admin_notes']);
        }
