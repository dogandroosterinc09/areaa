                ...
                <div class="row">
                    ...
                    <div class="col-md-3 footer__item">
                        <article>
                            <h4>Menu</h4>
                                <ul>
                                    <li><a href="{{ url('newyorkeast') }}">Home</a></li>
                                    <li><a href="{{ url('newyorkeast-aboutus') }}">About us</a></li>
                                    <li><a href="{{ url('newyorkeast-events') }}">Events</a></li>
                                    <li><a href="{{ url('newyorkeast-leadership') }}">Leadership</a></li>
                                    <li><a href="{{ url('newyorkeast-contactus') }}">Contact us </a></li>
                                    <li><a href="{{ url('newyorkeast-login') }}">Log in</a></li>
