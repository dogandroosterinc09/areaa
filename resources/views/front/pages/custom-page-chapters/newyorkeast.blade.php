            ...
            <div class="container-max">
                <div class="col-lg-12">
                        ...
                        <div class="heading-button">
                            ...
                            <a href="{{url('newyorkeast-events')}}" class="btn btn--view-all"> View all</a>
                        </div>
                                    ...
                                    <div class="col-md-9 content-middle">
                                        <div class="chapter-events-upcoming__content ">
                                            ...
                                            <div class="chapter-events-upcoming__description limit-me">
                                             ...
                                             <a href="{{url('newyorkeast-events')}}" class="btn btn--primary"> Read More Details <i class="fas fa-arrow-right"></i> </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="video-masking__content">
                            ...
                            <div class="video-masking__content--push">
                                ...
                                <div class="btn-group">
                                    ...
                                    <a href="{{ url('newyorkeast-contactus') }}" class="btn btn btn--primary">Contact us</a>
