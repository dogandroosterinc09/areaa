            ...
            <div class="container-max">
                <div class="col-lg-12">
                        ...
                        <div class="heading-button">
                            ...
                            <a href="{{url('atlantametro-events')}}" class="btn btn--view-all"> View all</a>
                        </div>
                            ...
                            <div class="chapter-events-upcoming__box">
                                <div class="row">
                                    <div class="col-md-3 chapter-events-upcoming__image">
                                        <a href="{{url('atlantametro-events')}}">
                                    ...
                                    <div class="col-md-9 content-middle">
                                        <div class="chapter-events-upcoming__content ">
                                            ...
                                            <div class="chapter-events-upcoming__description limit-me">
                                             ...
                                             <a href="{{url('atlantametro-events')}}" class="btn btn--primary"> Read More Details <i class="fas fa-arrow-right"></i> </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
