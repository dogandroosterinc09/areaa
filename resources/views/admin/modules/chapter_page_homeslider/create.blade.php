...
@section('content')
    ...
    <div class="row">
        {{  Form::open([
            'method' => 'POST',
            'id' => 'create-chapter_page_homeslider',
            'route' => ['admin.chapter_page_homesliders.store'],
                ...
                <div class="form-group{{ $errors->has('thumbnail_text') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <textarea id="home_slide_thumbnail_text" name="thumbnail_text" rows="9"
                                  ...
                                  class="form-control " placeholder="Enter Home Slide button link..">{{ old('thumbnail_text') }}</textarea>
