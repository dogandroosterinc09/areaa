...
@section('content')
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><span href="javascript:void(0)">Add New Chapter Home</span></li>
    </ul>
    <div class="row">
        {{  Form::open([
            'method' => 'POST',
            'id' => 'create-chapter_home',
            'route' => ['admin.chapter_homes.store'],
        ...
        <div class="col-md-12">
            <div class="block">
                <div class="block-title">
                    <h2><i class="fa fa-pencil"></i> <strong>Add new Chapter Home</strong></h2>
                </div>
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    <label class="col-md-3 control-label" for="chapter_home_name">Name</label>

                    <div class="col-md-9">
                        <input type="text" class="form-control" id="chapter_home_name" name="name"
                               placeholder="Enter Chapter Home name.." value="{{ old('name') }}">
                        @if($errors->has('name'))
                ...
                <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
                    <label class="col-md-3 control-label" for="chapter_home_slug">Slug</label>

                    <div class="col-md-9">
                        <input type="text" class="form-control" id="chapter_home_slug" name="slug"
                               placeholder="Enter Chapter Home slug.." value="{{ old('slug') }}">
                        @if($errors->has('slug'))
                ...
                <div class="form-group{{ $errors->has('banner_image') ? ' has-error' : '' }}">
                    <label class="col-md-3 control-label" for="chapter_home_banner_image">Banner Image</label>
                    <div class="col-md-9">
                ...
                <div class="form-group file-container {{ $errors->has('file') ? ' has-error' : '' }}">
                    <label class="col-md-3 control-label" for="chapter_home_file">File</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <label class="input-group-btn">
                            <span class="btn btn-primary">
                ...
                <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                    <label class="col-md-3 control-label" for="chapter_home_content">Content</label>

                    <div class="col-md-9">
                        <textarea id="chapter_home_content" name="content" rows="9"
                                  class="form-control ckeditor" placeholder="Enter Chapter Home content..">{{ old('content') }}</textarea>
