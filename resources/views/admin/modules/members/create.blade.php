...
@section('content')
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><span href="javascript:void(0)">Add New Members</span></li>
    </ul>
    <div class="row">
        {{  Form::open([
            'method' => 'POST',
        ...
        <div class="col-md-12">
            <div class="block">
                <div class="block-title">
                    <h2><i class="fa fa-pencil"></i> <strong>Add new Members</strong></h2>
                </div>
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="members_name" name="name"
                               placeholder="Enter Members name.." value="{{ old('name') }}">
                        @if($errors->has('name'))
                ...
                <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="members_slug" name="slug"
                               placeholder="Enter Members slug.." value="{{ old('slug') }}">
                        @if($errors->has('slug'))
                ...
                <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <textarea id="members_content" name="content" rows="9"
                                  class="form-control ckeditor" placeholder="Enter Members content..">{{ old('content') }}</textarea>
