                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <h4 style="border-left: 3px solid #ab1a2d; padding-left: 8px; margin-bottom: 20px;"><input type='button' value='Add Featured Sponsors' id='addSponsor' class="btn btn-sm btn-primary"></h4>
