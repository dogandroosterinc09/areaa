                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <h4 style="border-left: 3px solid #ab1a2d; padding-left: 8px; margin-bottom: 20px;"><input type='button' value='Add Partnership' id='addPartnership' class="btn btn-sm btn-primary"></h4>
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="delete">&nbsp;
                                    <input type="hidden" name="partnership_id[]" value="{{$counter}}">
                                </label>
                                <div class="col-md-10">
