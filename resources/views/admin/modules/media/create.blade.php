        ...
        <div class="col-md-12">
            <div class="block">
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="media_name" name="name"
                               placeholder="Enter Media name.." value="{{ old('name') }}">
                        @if($errors->has('name'))
                ...
                <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="media_slug" name="slug"
                               placeholder="Enter Media slug.." value="{{ old('slug') }}">
                        @if($errors->has('slug'))
                ...
                <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <textarea id="media_content" name="content" rows="9"
                                  class="form-control ckeditor" placeholder="Enter Media content..">{{ old('content') }}</textarea>
