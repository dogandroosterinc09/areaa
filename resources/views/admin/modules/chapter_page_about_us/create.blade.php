...
@section('content')
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><span href="javascript:void(0)">Add New Chapter Page About Us</span></li>
    </ul>
    <div class="row">
        {{  Form::open([
            'method' => 'POST',
            'id' => 'create-chapter_page_about_us',
            'route' => ['admin.chapter_page_about_uses.store'],
        ...
        <div class="col-md-12">
            <div class="block">
                <div class="block-title">
                    <h2><i class="fa fa-pencil"></i> <strong>Add new Chapter Page About Us</strong></h2>
                </div>
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    <label class="col-md-3 control-label" for="chapter_page_about_us_name">Name</label>

                    <div class="col-md-9">
                        <input type="text" class="form-control" id="chapter_page_about_us_name" name="name"
                               placeholder="Enter Chapter Page About Us name.." value="{{ old('name') }}">
                        @if($errors->has('name'))
                ...
                <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
                    <label class="col-md-3 control-label" for="chapter_page_about_us_slug">Slug</label>

                    <div class="col-md-9">
                        <input type="text" class="form-control" id="chapter_page_about_us_slug" name="slug"
                               placeholder="Enter Chapter Page About Us slug.." value="{{ old('slug') }}">
                        @if($errors->has('slug'))
                ...
                <div class="form-group{{ $errors->has('banner_image') ? ' has-error' : '' }}">
                    <label class="col-md-3 control-label" for="chapter_page_about_us_banner_image">Banner Image</label>
                    <div class="col-md-9">
                ...
                <div class="form-group file-container {{ $errors->has('file') ? ' has-error' : '' }}">
                    <label class="col-md-3 control-label" for="chapter_page_about_us_file">File</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <label class="input-group-btn">
                            <span class="btn btn-primary">
                ...
                <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                    <label class="col-md-3 control-label" for="chapter_page_about_us_content">Content</label>

                    <div class="col-md-9">
                        <textarea id="chapter_page_about_us_content" name="content" rows="9"
                                  class="form-control ckeditor" placeholder="Enter Chapter Page About Us content..">{{ old('content') }}</textarea>
