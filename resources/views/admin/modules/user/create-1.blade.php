...
@section('content')
    <ul class="breadcrumb breadcrumb-top">
        <li><a href="{{ route('admin.user.index_admin') }}">Admins</a></li>
        <li><span href="javascript:void(0)">Add New Admin</span></li>
    </ul>
    <div class="row">
        {{  Form::open([
            'method' => 'POST',
            'id' => 'create-user',
            'route' => ['admin.user.store_admin'],
        ...
        <div class="col-md-12">
            <div class="block">
                <div class="block-title">
                    <h2><i class="fa fa-pencil"></i> <strong>Add new Admin</strong></h2>
                </div>
