...
@section('content')
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><span href="javascript:void(0)">Edit Account</span></li>
    </ul>
    <div class="row">
        {{  Form::open([
            'method' => 'POST',
        ...
        <div class="col-md-12">
            <div class="block">
                <div class="block-title">
                    <h2><i class="fa fa-pencil"></i> <strong>Edit Account "{{$user->first_name.' '.$user->last_name}}"</strong></h2>
                </div><?php
                // print_r(auth()->user());
                // echo auth()->user();
                ?>
                ...
                <input type="text" id="is_active" name="is_active" value="1" hidden>
