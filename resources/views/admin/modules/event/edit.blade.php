                        ...
                        <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="number" class="form-control" id="amount" name="amount"
                                       value="{{ old('amount')? old('amount') : $event->amount? $event->amount : '' }}" placeholder="Enter Regular Amount.." min='0' step="0.01">
                        ...
                        <div class="form-group{{ $errors->has('amount_member') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="number" class="form-control" id="amount_member" name="amount_member"
                                       value="{{  old('amount_member')? old('amount_member') : $event->amount_member? $event->amount_member : '' }}" placeholder="Enter Amount Member.." min='0' step="0.01">
