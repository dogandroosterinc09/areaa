    ...
    public function run()
    {
        ...
        \DB::table('sections')->insert(array (
            ...
            'value' => '{"options":{"create":false},"fields":[{"name":"Featured Image","type":"attachment","alias":"image"},{"name":"Alt Text","type":"text","alias":"alt_text"},{"name":"Title","type":"text"},{"name":"Content","type":"editor"},{"name":"Button1 Text","type":"text","alias":"btn1_text"},{"name":"Button1 Link","type":"text","alias":"btn1_link"},{"name":"Button2 Text","type":"text","alias":"btn2_text"},{"name":"Button2 Link","type":"text","alias":"btn2_link"}],"data":[{"image":"17","alt_text":"Members Image","title":"Become a Member","content":"<p><span style=\\"font-size:18px;\\">With over&nbsp;<span style=\\"color:#ab1a2d;\\"><b>17,000 members</b></span>&nbsp;in&nbsp;<span style=\\"color:#ab1a2d;\\"><b>41 chapters</b></span>&nbsp;across the US and Canada, AREAA is&nbsp;<b>the largest Asian American and Pacific Islander (AAPI) trade organization in North America</b>.</span></p>\\n\\n<p><span style=\\"font-size:16px;\\">As a member, you’ll receive discounted pricing to all AREAA events, FREE webinar training to help fine-tune your skill sets, and be able to participate in International Trade missions. The benefits don’t stop there; below are more reasons as to why it pays to be an AREAA Member.</span></p>\\n","btn1_text":"Learn More","btn1_link":"#","btn2_text":"Become a Member","btn2_link":"#"}]}',
                'created_at' => '2020-03-17 15:37:49',
                'updated_at' => '2020-03-17 16:32:50',
                'deleted_at' => NULL,
            ),
            1 => 
            array (
                ...
                'created_at' => '2020-03-17 15:39:06',
                'updated_at' => '2020-03-17 16:35:42',
                'deleted_at' => NULL,
            ),
            2 => 
            array (
                ...
                'name' => 'Partnership',
                'type' => 3,
                'value' => '{"options":{"create":false},"fields":[{"name":"Featured Image","type":"attachment","alias":"image"},{"name":"Alt Text","type":"text","alias":"alt_text"},{"name":"Title","type":"text"},{"name":"Content","type":"editor"},{"name":"Button1 Text","type":"text","alias":"btn1_text"},{"name":"Button1 Link","type":"text","alias":"btn1_link"},{"name":"Button2 Text","type":"text","alias":"btn2_text"},{"name":"Button2 Link","type":"text","alias":"btn2_link"}],"data":[{"image":"19","alt_text":"Partnership BG","title":"Partnership","content":"<span style=\\"font-size:24px;\\">We have more than 30 partners from<br />\\n<b>Local</b>&nbsp;to&nbsp;<b>International</b>.</span>","btn1_text":"Learn More","btn1_link":"#","btn2_text":"Become a Member","btn2_link":"#"}]}',
                'created_at' => '2020-03-17 15:41:27',
                'updated_at' => '2020-03-17 16:46:16',
                'deleted_at' => NULL,
            ),
            3 => 
            array (
                ...
                'created_at' => '2020-03-17 15:42:45',
                'updated_at' => '2020-03-17 18:24:14',
                'deleted_at' => NULL,
            ),
            4 => 
            array (
            ...
            array (
                ...
                'created_at' => '2020-03-17 15:52:10',
                'updated_at' => '2020-03-17 16:54:47',
                'deleted_at' => NULL,
            ),
            6 => 
            array (
                ...
                'created_at' => '2020-03-17 15:55:44',
                'updated_at' => '2020-03-17 16:54:47',
                'deleted_at' => NULL,
            ),
            7 => 
            array (
                ...
                'created_at' => '2020-03-17 15:58:31',
                'updated_at' => '2020-03-17 16:54:47',
                'deleted_at' => NULL,
            ),
            8 => 
            array (
                ...
                'created_at' => '2020-03-17 16:00:20',
                'updated_at' => '2020-03-17 17:10:15',
                'deleted_at' => NULL,
            ),
            9 => 
            array (
            ...
            array (
                ...
                'created_at' => '2020-03-17 16:04:38',
                'updated_at' => '2020-03-17 17:24:14',
                'deleted_at' => NULL,
            ),
            12 => 
            array (
                ...
                'created_at' => '2020-03-17 16:05:46',
                'updated_at' => '2020-03-17 17:24:14',
                'deleted_at' => NULL,
            ),
            13 => 
            ...
            'value' => '{"options":{"create":false},"fields":[{"name":"Title","type":"text"},{"name":"Content","type":"textarea"},{"name":"Button1 Text","type":"text","alias":"btn1_text"},{"name":"Button1 Link","type":"text","alias":"btn1_link"},{"name":"Button2 Text","type":"text","alias":"btn2_text"},{"name":"Button2 Link","type":"text","alias":"btn2_link"}],"data":[{"title":"AREAA’S MEMBERSHIP REPRESENTS A VAST ARRAY OF CULTURAL, ETHNIC, & PROFESSIONAL BACKGROUNDS.","content":"Founded in 2003, the Asian Real Estate Association of America (AREAA) is a nonprofit professional trade organization dedicated to promoting sustainable homeownership opportunities in Asian American communities by creating a powerful national voice for housing and real estate professionals that serve this dynamic market.","btn1_text":"View Our Partners","btn1_link":"#","btn2_text":"Become a Member","btn2_link":"#"}]}',
                'created_at' => '2020-03-17 16:08:16',
                'updated_at' => '2020-03-17 17:24:14',
                'deleted_at' => NULL,
            ),
            14 => 
            ...
            array (
                ...
                'created_at' => '2020-03-17 16:15:37',
            ...
            array (
                ...
                'created_at' => '2020-03-17 16:17:00',
                'updated_at' => '2020-03-17 17:41:39',
                'deleted_at' => NULL,
            ),
            18 => 
            array (
                ...
                'created_at' => '2020-03-17 16:20:55',
                'updated_at' => '2020-03-17 17:58:46',
                'deleted_at' => NULL,
            ),
            19 => 
            array (
                ...
                'created_at' => '2020-03-17 16:24:46',
                'updated_at' => '2020-03-17 18:09:38',
                'deleted_at' => NULL,
            ),
            20 => 
            array (
                ...
                'created_at' => '2020-03-17 16:26:20',
                'updated_at' => '2020-03-17 18:10:54',
                'deleted_at' => NULL,
            ),
            21 => 
            array (
